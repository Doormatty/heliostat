registers = {
    'Charging equipment input power': {'description': 'PV array power'},
    'Charging equipment rated input power': {'description': 'MAX PV array power'},
    'Charging equipment input current': {'description': 'PV array current'},
    'Charging equipment input voltage': {'description': 'PV array voltage}'},
    'Charging equipment rated input voltage': {'description': 'MAX PV array voltage'},
    ...
    'Discharging equipment output current': {'description': 'Load current'}
}
